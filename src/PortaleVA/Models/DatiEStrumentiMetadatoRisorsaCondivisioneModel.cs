...
{
    public class DatiEStrumentiMetadatoRisorsaCondivisioneModel : PaginaDinamicaModel
    {
        public DatiEStrumentiMetadatoRisorsaCondivisioneModel()
        {
        ...
        public DocumentoCondivisione Risorsa { get; set; }
